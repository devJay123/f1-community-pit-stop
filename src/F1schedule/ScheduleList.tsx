...
const ScheduleList: React.FC = () => {
  ...
  const remainingRaces = upcomingRaces.slice(1).concat(races.filter((race) => new Date(race.date) < currentDate));
  ...
  return (
    <Container >
      <div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap",  gap: "20px", padding:"5px", justifyContent:'center'}}>
