...
const ScheduleList: React.FC = () => {
    ...
    return (
        ...
        <div>
            ...
            <div style={{backgroundColor:'rgba(25, 25, 25, 0.786)', width:'100%', height:'250px', marginTop:'20px', marginBottom:'20px'}}>
                <Card></Card>
            </div>
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '20px' }}>
            {races.map((race) => (
                <div key={race.round} style={{ width: '300px', marginBottom: '20px' }}>
